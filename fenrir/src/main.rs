...
fn main() {
    let comp_config_dir: PathBuf = Path::new("/work/kurokawa/project_fenrir/config").join("mk1-comp.toml");
    let mpi_config_dir: PathBuf = Path::new("/work/kurokawa/project_fenrir/config").join("mk1-mpi.toml");
    let evaluation_mcts_config_dir: PathBuf = Path::new("/work/kurokawa/project_fenrir/config").join("mk1-eval_mcts.toml");
    let data_store_dir = "/fast/$USER/fenrir";
